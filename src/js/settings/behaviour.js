($ => {
    ...
    window.BehaviourHelper = function (s) {
        ...
        this.init = () => {
            ...
            ["rememberSearch", "dirAccordion", "preventPageScroll", "initialOpenOnNewTab"].forEach((field) => {
        ...
        this.save = () => {
            ...
            ["rememberSearch", "dirAccordion", "preventPageScroll", "initialOpenOnNewTab"].forEach((field) => { // checkbox

($ => {
    ...
    window.SidebarHelper = function (s) {
        ...
        this.init = async () => {
            ...
            ["dirAccordion", "animations", "contextmenu", "preventPageScroll", "reopenSidebar", "dndOpen"].forEach((field) => {
        ...
        this.save = () => {
            return new Promise((resolve) => {
                ...
                ["dirAccordion", "animations", "contextmenu", "preventPageScroll", "reopenSidebar", "dndOpen"].forEach((field) => { // checkbox
        ...
        let initEvents = async () => {
            ...
            s.opts.elm.buttons.keyboardShortcut.on("click", (e) => {
                e.preventDefault();
                let versionRaw = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./); // @deprecated url of shortcut page has changed with Chrome 64 -> switch for older versions can be removed when min required version >= 64
